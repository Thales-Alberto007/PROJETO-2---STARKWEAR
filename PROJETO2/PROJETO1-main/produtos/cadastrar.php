...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    // Validação básica
    if (empty($nome) || empty($preco) || empty($colecao)) {
        $mensagem = "Por favor, preencha nome, preço e coleção.";
        ...
        // Prepared Statement para inserir o novo produto
        $stmt = mysqli_prepare($conexao, "INSERT INTO produtos (nome, preco, descricao, colecao, imagem, desconto) VALUES (?, ?, ?, ?, ?, ?)");
        mysqli_stmt_bind_param($stmt, "sdsssd", $nome, $preco, $descricao, $colecao, $imagem, $desconto); // 'sdsssd' para string, decimal, string, string, string, decimal
...
<head>
    <meta charset="UTF-8">
    <title>Status Cadastro de Produto</title>
...
<body>
    ...
    <div class="container-admin">
        <h2>Status do Cadastro de Produto</h2>
